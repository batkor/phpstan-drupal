...
namespace mglaman\PHPStanDrupal\Drush\Generators;

use DrupalCodeGenerator\Asset\AssetCollection;
use DrupalCodeGenerator\Attribute\Generator;
use DrupalCodeGenerator\Command\BaseGenerator;
use DrupalCodeGenerator\GeneratorType;
use mglaman\PHPStanDrupal\Drush\Assets\AssetsInterface;
...
class MetaMapGenerator extends BaseGenerator
{
    ...
    protected function generate(array &$vars, AssetCollection $assets): void
    {
        ...
        foreach ($iterator as $fileinfo) {
            ...
            $class = 'mglaman\\PHPStanDrupal\\Drush\\Assets\\' . $subNamespace . $fileinfo->getBasename('.php');
